...
export const Header = () => {
  ...
  return (
   <>
    ...
    <button className='bg-black px-10 max-md:text-[2.7vw] max-md:border-[4px] border-[5px] py-2.5 rounded-full select-none text-white font-[anzo] relative hover:bg-gray-400 max-md:fixed max-md:bottom-4 max-md:left-1/2 max-md:transform max-md:-translate-x-1/2'>
        Hire me
    </button>
    <i className="max-md:opacity-0 ri-more-2-line text-4xl text-gray-600"></i>
        ...
        <i className="ri-menu-3-line text-[8vw] cursor-pointer"></i>
          <h2 className='text-[12vw] tracking-wide'>HELLO</h2>
      </div>
