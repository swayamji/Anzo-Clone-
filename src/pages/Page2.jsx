...
const Page2 = () => {
  ...
  return (
    <div className='section2 bg-white text-center p-16 max-md:p-8  text-black overflow-x-hidden'>
        ...
        <div className='same'>
            <h2 className='text-[40vw] leading-[35vw] font-[anzo5]'>DESIGN</h2>
        </div>
        <div className='same'>
            <h2 className='text-[40vw] leading-[35vw] font-[anzo5]'>IS THE</h2>
        </div>
        <div className='same' >
            <h2 className='text-[40vw] leading-[35vw] font-[anzo5]' >DESIGN</h2>
        </div>
        <div className='same'>
            <h2 className='text-[40vw] leading-[35vw] font-[anzo5]'>THAT</h2>
        </div>
        <div className='same'>
            <h2 className='text-[40vw] leading-[35vw] font-[anzo5]'>WORKS!</h2>
        </div>

        <div className='flex items-center justify-center scale-[0.63] max-md:scale-95'> 
        ...
        <div className='line h-1 w-[26vw] left-1/2 mt-16 relative -translate-x-1/2 border-b-2 bg-black max-md:mt-0 max-md:border-b-2'></div>
