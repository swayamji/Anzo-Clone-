...
const Page7 = () => {
  ...
  return (
    <>
        <div className='h-screen bg-white p-6 mx-5'>
            <div className='section7 bg-black w-full h-[70vw] rounded-[50px] relative'>
                ...
                <div className='Hero absolute top-1 flex gap-[44vw] mt-24'> 
                ...
                <div className='hey absolute top-[38vw] w-full h-[25vw] flex gap-20 items-center text-[1.3vw] leading-[1.8vw] font-[anzo2] text-[#9B9B9B] p-20'>
                    ...
                    <div>
                        ...
                        <div className='flex mt-16 items-baseline gap-[2vw]'>
                        <img className='rotate1' src="https://static.wixstatic.com/media/f1c650_67833facdc7a47d5aae7870d4fb7fc3e~mv2.png/v1/fill/w_85,h_85,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/SUN.png" alt="" />
                    ...
                    <div>
                        ...
                        <div className='flex mt-16 items-baseline gap-[2vw]'>
                        <img className='rotate2' src="https://static.wixstatic.com/media/f1c650_027515148725478cbb3a91eca452cabf~mv2.png/v1/fill/w_82,h_82,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/EARTH.png" alt="" />
                    ...
                    <div>
                        ...
                        <div className='flex mt-16 items-baseline gap-[2vw]'>
                        <img className='rotate3' src="https://static.wixstatic.com/media/f1c650_b0000fd9a706421aa0ea84da62ae3354~mv2.png/v1/fill/w_82,h_82,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/START%20UP.png" alt="" />
                        <h3 className='font-[anzo5] text-[4.5vw] text-white'>BRANDING <span className='text-[1.3vw] font-[anzo2]'>03</span></h3>
                        </div>
                    </div>

                </div>
                <div className='absolute bottom-10 text-[#9B9B9B] font-[anzo3] text-[1.2vw] left-16 leading-[1.6vw]'>
