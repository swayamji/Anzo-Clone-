...
const Page3 = () => {
  return (
    <>
    <div className='h-screen relative flex justify-center items-center bg-white'>
        ...
        <video autoPlay loop muted className='h-[35vw] w-[50vw] object-cover relative z-10 max-md:mt-[-150vw]' src="https://video.wixstatic.com/video/f1c650_ec0546cb7b10485c8753983f298c6ea4/360p/mp4/file.mp4"></video>
